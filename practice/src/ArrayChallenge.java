...
the strArr parameter being passed which will 
represent a full day and will be filled with events 
that span from time X to time Y in the day. The format 
of each event will be hh:mmAM/PM-hh:mmAM/PM. For example, 
strArr may be [10:00AM-12:30PM","02:00PM

02:45PM","09:10AM-09:50AM"]. 
...
input would therefore be 01:30 (with the earliest event in the day starting at 
        09:10AM and the latest event ending at 02:45PM). The input will contain 
...
public class ArrayChallenge {
    ...
    String ArrayChallen(String[] strArr)
    {
    ...
    public static void main (String[] args) {
        ...
        ArrayChallenge c = new  ArrayChallenge();
        System.out.print(c.ArrayChallen(new String[] {
